  ...
  <div class="container mx-auto px-4 py-8">
    <div class="flex gap-4 mb-6 mx-auto px-2 md:px-4 max-w-[1600px]">
      <div class="flex items-center gap-2">
        ...
        <select v-model="selectedGrade" class="px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
      ...
      <div class="flex items-center gap-2">
        ...
        <select v-model="selectedVolume" class="px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
          <option value="all">全部</option>
